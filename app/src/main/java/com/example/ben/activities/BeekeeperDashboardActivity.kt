...
import com.example.ben.databinding.ActivityBeekeeperDashboardBinding
...
class BeekeeperDashboardActivity : AppCompatActivity() {

    private lateinit var binding: ActivityBeekeeperDashboardBinding
    private val authViewModel: AuthViewModel by viewModels()
    private val mainViewModel: MainViewModel by viewModels()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityBeekeeperDashboardBinding.inflate(layoutInflater)
